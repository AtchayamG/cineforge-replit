...
## 1. System Overview
**CineForge Replit** combines a published **Replit App** with **Google Gemini 3.7 Flash** to provide a zero-setup cinema review studio.
...
graph TD
    ...
    CoDirector --> Gemini[🌟 Google Gemini 3.7 Flash<br/>(Dialogue & Visual Direction)]
...
3. **Gemini 3.7 Co-Direction**: Calls `google-genai` in live mode to generate dialogue delivery notes and camera, lighting, sound, and visual-staging guidance.
